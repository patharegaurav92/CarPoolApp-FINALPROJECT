...
/**
 * Created by Chinmay Deshpande on 5/6/2017.
 */
...
import static edu.student.android.chatappvolley.features.MathUtil.EARTH_RADIUS;
import static edu.student.android.chatappvolley.features.MathUtil.clamp;
import static edu.student.android.chatappvolley.features.MathUtil.hav;
import static edu.student.android.chatappvolley.features.MathUtil.havDistance;
import static edu.student.android.chatappvolley.features.MathUtil.havFromSin;
import static edu.student.android.chatappvolley.features.MathUtil.inverseMercator;
import static edu.student.android.chatappvolley.features.MathUtil.mercator;
import static edu.student.android.chatappvolley.features.MathUtil.sinFromHav;
import static edu.student.android.chatappvolley.features.MathUtil.sinSumFromHav;
import static edu.student.android.chatappvolley.features.MathUtil.wrap;
import static java.lang.Math.*;
import edu.student.android.chatappvolley.features.MathUtil.*;
...
public class PolyUtil {
    ...
    public static boolean isLocationOnPath(LatLng point, List<LatLng> polyline,
        ...
        return isLocationOnEdgeOrPath(point, polyline, true, geodesic, tolerance);
    }
